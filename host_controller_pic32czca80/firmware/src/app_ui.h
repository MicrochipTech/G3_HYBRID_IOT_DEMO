...
#define UI_QUEUE_DATA_SIZE 16
#define APP_UI_QUEUE_COUNT 32
...
#define UI_DPRINTF(...) 
    ...
    typedef enum
    {
        ...
        APP_EVENT_WIFI_AVAILABLE,
        APP_EVENT_WIFI_CONNECTED,
        APP_EVENT_WIFI_DISCONNECTED,
        APP_EVENT_WIFI_MQTT_CONNECTED,
        APP_EVENT_WIFI_MQTT_DISCONNECTED,
                
        APP_EVENT_COORD_RESET,
        APP_EVENT_COORD_HEARTBEAT,
        APP_EVENT_COORD_ALARM,
        APP_EVENT_COORD_DEVICE_JOIN,
        APP_EVENT_COORD_DEVICE_LEAVE,
        APP_EVENT_COORD_DEVICE_ALIVE,
        APP_EVENT_COORD_DEVICE_STATE        
    } APP_UI_EVENTS;
