...
extern "C" {
    ...
    #define LTEIOT10_MQTT_CLOUD_URL                     "\"test.mosquitto.org\""
    #define LTEIOT10_MQTT_SUB_TOPIC                     "\"endpointId/dcx/token2\""
    #define LTEIOT10_MQTT_PUB_TOPIC                     "\"endpointId/dcx/token2/json\""


#define APP_LTE_CMD_RX_BUFFER_SIZE  100
...
typedef struct {
    ...
    /* MQTT message counter received over LTE-Module reported back */
    int mqttRecMessCntLtemReported;
    /* Alarm status published over LTE-Module */
    bool alarmStatus;
    bool alarmStatusPublished;
    /* light_indoor status published over LTE-Module */
    bool lightIndoorStatus;
    bool lightIndoorStatusPublished;
    /* light_outdoor status published over LTE-Module */
    ...
    /* LTE Notification callbacks */
    APP_LTE_NOTIF_CALLBACK notifCallbacks[APP_LTE_NOTIF_CALLBACK_COUNT];
}APP_LTE_DATA_T;
...
bool APP_LTE_GetStatus(uint32_t *status);
