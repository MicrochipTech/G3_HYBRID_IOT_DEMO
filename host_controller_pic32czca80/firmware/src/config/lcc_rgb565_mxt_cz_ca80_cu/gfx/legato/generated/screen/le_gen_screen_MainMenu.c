...
leImageWidget* MainMenu_ImageWidget_0;
...
leResult screenShow_MainMenu(void)
{
    ...
    MainMenu_LabelWidget0->fn->setPosition(MainMenu_LabelWidget0, 552, 2);
    MainMenu_LabelWidget0->fn->setSize(MainMenu_LabelWidget0, 247, 25);
    ...
    MainMenu_ConnectButton->fn->setPosition(MainMenu_ConnectButton, 579, 186);
    ...
    MainMenu_ImageWidget_0 = leImageWidget_New();
    MainMenu_ImageWidget_0->fn->setPosition(MainMenu_ImageWidget_0, 82, 70);
    MainMenu_ImageWidget_0->fn->setSize(MainMenu_ImageWidget_0, 421, 365);
    MainMenu_ImageWidget_0->fn->setBorderType(MainMenu_ImageWidget_0, LE_WIDGET_BORDER_NONE);
    MainMenu_ImageWidget_0->fn->setImage(MainMenu_ImageWidget_0, (leImage*)&Hybrid_IoT_Demo);
    root0->fn->addChild(root0, (leWidget*)MainMenu_ImageWidget_0);
