...
// screen IDs
#define screenID_ControlScreen    0
#define screenID_LightControlScreen    1
#define screenID_MainMenu    2
#define screenID_MultiLinkConnectScreen    3
#define screenID_SWallControlScreen    4
#define screenID_SignalingControl    5
