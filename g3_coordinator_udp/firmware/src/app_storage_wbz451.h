/*******************************************************************************
  ...
  Description:
    ...
    "APP_STORAGE_WBZ451_Initialize" and "APP_STORAGE_WBZ451_Tasks"
    prototypes) and some of them are only used internally by the application
    (such as the "APP_STORAGE_WBZ451_STATES" definition). Both are defined
    here for convenience.
*******************************************************************************/

#ifndef _APP_STORAGE_WBZ451_H
#define _APP_STORAGE_WBZ451_H
...
/*******************************************************************************
  ...
  Description:
    ...
    APP_STORAGE_WBZ451_Tasks function can be called.
...
/*******************************************************************************
  ...
  Precondition:
    APP_STORAGE_WBZ451_Initialize should be called before calling this
    routine.
